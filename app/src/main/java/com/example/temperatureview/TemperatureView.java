...
public class TemperatureView extends View {
    ...
    private int pointTopY       = (int) (44  * Util.getDensity(getContext()));
    ...
    public void onDraw(Canvas canvas) {
        ...
        pointY = (mMiddleValue + (int) ((pointBottomY-pointTopY) * 1f / (maxValue - minValue) * ((maxValue + minValue) / 2 - currentValue)))/10+50;
        //pointY = 10000/650*currentValue/100;
    ...
    private void drawValue(Canvas canvas){
        ...
        canvas.drawText(currentValue*0.01+"°",pointX , pointY - 20, mPaint);
    }
    ...
    public void setTextColor(){
        ...
        }else if(currentValue <= 200 && currentValue > 100){
            mPaint.setColor(Color.GREEN);
        }else if(currentValue <= 300 && currentValue > 200){
            mPaint.setColor(0xFFFF8000);
        }else if(currentValue <= 400 && currentValue > 300){
    ...
    public void drawGraph(Canvas canvas){
        ...
        if(isDrawLeftLine){
            ...
            canvas.drawLine(0, middleY/10+50, pointX, pointY, mPaint);
        }
        ...
        if(isDrawRightLine){
            ...
            float middleY = mMiddleValue + (int) ((pointBottomY-pointTopY) * 1f / (maxValue - minValue) * ((maxValue + minValue) / 2 - middleValue));
            canvas.drawLine(pointX, pointY, viewWidth, middleY/10+50, mPaint);
        }
    }
}
